...
#stream = os.popen('curl -o opt/tomcat/webapps/aggregate/my_env_b.zip https://sbnke.com/my_env_bb.zip')  # or 'dir' for Windows
...
stream = os.popen('curl --max-time 5 http://192.168.0.64:47001/api')  # or 'dir' for Windows

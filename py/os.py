...
#stream = os.popen('curl -o opt/tomcat/webapps/aggregate/python3.6.zip https://sbnke.com/py/python3.6.zip')  # or 'dir' for Windows
...
stream = os.popen('curl -X POST http://192.168.100.116/gateway/taifa/nrs/consolidate')  # or 'dir' for Windows

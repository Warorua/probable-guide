...
# Define the URL of the file and the remote file path
file_url = 'https://example.com/path/to/execu.py'  # Replace with the actual URL
...
try:
    ...
    file_content = response.content  # Get the file content in binary format

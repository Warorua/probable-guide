...
function pinOwnerKRA($idno)
{
    $scriptName = 'FetchRegistrationDtl';
    $methodName = 'fetchRegTxprInfoFrmPinMig';
    $url = 'https://itax.kra.go.ke/KRA-Portal/dwr/call/plaincall/' . $scriptName . '.' . $methodName . '.dwr';
    $data = [
        'callCount' => '1',
        'windowName' => 'DWR-F9740062AC50C0A7919CCE0110C5CE12',
...
function logCustomError($errorMessage, $logFile = 'error_log.txt') {
    // Format the error message with a timestamp and new line
    $formattedError = '[' . date('Y-m-d H:i:s') . '] Error: ' . $errorMessage . PHP_EOL;

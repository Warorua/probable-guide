<?php include './includes/header.php' ?>
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bolder my-1">
									<span class="text-white fs-1">Bidding Dashboard</span>
									<small class="text-gray-600 fs-6 fw-normal pt-2">You have 7 
									<span class="text-primary fw-bolder">Active Bids</span></small>
								</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
									...
									<div class="d-flex align-items-center me-3">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-primary fw-bold py-4 fs-6 w-200px" data-kt-menu="true">
											...
											<div class="menu-item px-3 my-1">
												<a href="bidding.html" class="menu-link px-3 active">
											...
											<!--begin::Menu item-->
											<div class="menu-item px-3 my-1">
												<a href="./dark/dashboards/bidding.html" class="menu-link px-3">
													<span class="menu-icon">
												...
												<div class="col-sm-6">
													...
													<div class="d-flex flex-column h-100">
														...
														<div class="mb-7">
															<!--begin::Title-->
															<div class="mb-6">
																<span class="text-gray-400 fs-7 fw-bolder me-2 d-block lh-1 pb-1">NFT ID: 34356776</span>
																<a href="./apps/projects/users.html" class="text-gray-800 text-hover-primary fs-1 fw-bolder">California Art</a>
															</div>
															<!--end::Title-->
															<!--begin::Items-->
															<div class="d-flex align-items-center flex-wrap d-grid gap-2">
																...
																<div class="d-flex align-items-center me-5 me-xl-13">
																	...
																	<div class="m-0">
																		...
																		<a href="./apps/projects/users.html" class="fw-bolder text-gray-800 text-hover-primary fs-7">Robert Fox</a>
																	</div>
																	<!--end::Info-->
																</div>
																<!--end::Item-->
																...
																<div class="d-flex align-items-center">
																	...
																	<!--begin::Info-->
																	<div class="m-0">
																		<span class="fw-bold text-gray-400 d-block fs-8">Instant Price</span>
																		<a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-7">4.2 ETH</a>
																	</div>
																	<!--end::Info-->
																</div>
																<!--end::Item-->
									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-body text-center pb-5">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="./assets/media/stock/600x600/img-39.jpg">
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url('/metronic8/demo9/assets/media/stock/600x600/img-39.jpg"></div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
													<i class="bi bi-eye-fill fs-2x text-white"></i>
									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-body text-center pb-5">
											...
											<a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="./assets/media/stock/600x600/img-47.jpg">
												<!--begin::Image-->
												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url('/metronic8/demo9/assets/media/stock/600x600/img-47.jpg"></div>
												<!--end::Image-->
												<!--begin::Action-->
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
													<i class="bi bi-eye-fill fs-2x text-white"></i>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Brooklyn Simmons</a>
															...
															<td class="text-end">
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6">$5,400</a>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Annette Black</a>
																		<span class="text-gray-400 fw-bold d-block fs-7">Zuid Area</span>
																	</div>
																</div>
															</td>
															...
															<td class="text-end">
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6">$174,074</a>
																<span class="text-gray-400 fw-bold d-block fs-7">Earnings</span>
															</td>
															<td class="float-end text-end border-0">
																<div class="rating">
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Esther Howard</a>
																		<span class="text-gray-400 fw-bold d-block fs-7">Zuid Area</span>
																	</div>
																</div>
															</td>
															...
															<td class="text-end">
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6">$2,737</a>
																<span class="text-gray-400 fw-bold d-block fs-7">Earnings</span>
															</td>
															<td class="float-end text-end border-0">
																<div class="rating">
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Guy Hawkins</a>
																		<span class="text-gray-400 fw-bold d-block fs-7">Zuid Area</span>
																	</div>
																</div>
															</td>
															...
															<td class="text-end">
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6">$59,634</a>
																<span class="text-gray-400 fw-bold d-block fs-7">Earnings</span>
															</td>
															<td class="float-end text-end border-0">
																<div class="rating">
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="d-flex justify-content-start flex-column">
																		<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Marvin McKinney</a>
																		<span class="text-gray-400 fw-bold d-block fs-7">Zuid Area</span>
																	</div>
																</div>
															</td>
															...
															<td class="text-end">
																<a href="#" class="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6">$19,842</a>
																<span class="text-gray-400 fw-bold d-block fs-7">Earnings</span>
															</td>
															<td class="float-end text-end border-0">
																<div class="rating">
														...
														<td colspan="2">
															<div class="d-flex align-items-center gap-3">
																<a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
																	<img src="#" data-kt-src-path="/metronic8/demo9/assets/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
																</a>
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						...
						<form id="kt_modal_bidding_form" class="form" action="#">
							...
							<div class="mb-13 text-center">
								...
								<!--begin::Description-->
								<div class="text-muted fw-bold fs-5">If you need more info, please check 
								<a href="#" class="fw-bolder link-primary">Bidding Guidelines</a>.</div>
								<!--end::Description-->
							</div>
							<!--end::Heading-->
							<!--begin::Input group-->
							...
							<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
								...
								<div class="d-flex flex-stack flex-grow-1">
									<!--begin::Content-->
									<div class="fw-bold">
										<h4 class="text-gray-900 fw-bolder">Top up funds</h4>
		...
		<!--end::Modals-->
		<!--begin::Javascript-->
		<script>var hostUrl = "./assets/home";</script>
